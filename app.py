...
# Σελίδα Info
    ...
    **Ομάδα Ανάπτυξης:**
    - Σταμάτης Καλλιπόσης: Ανάπτυξη της Ανάπτυξη της web based εφάρμογγης
    - Φίλλιπος Μπιτόπουλος: Βοήθεια στην ανάπτυξη της εφαρμόγης , δοκιμες και συγγραφή της τεκμηρίωσης
